...
object DataframesBasics extends App {
   ...
   *   - print its schema
   *   - count the number of rows (call count method)
   */
  ...
  val phones = Seq(
    ("Apple", "Iphone X", "50x50", 20),
    ("Samsung", "Flip", "70x100", 40)
  )

  val phoneDF = phones.toDF("Brand", "Model", "Screen Dimension", "Camera Megapixels")
  phoneDF.show()
